...
public class Main {
    ...
    public final static void main(String[] args) throws Exception {
        ...
        /*
         * // read XML design Design design =
         * XmlDesign.readXMLDesign("designs/tarjan_test.xml"); design.update();
         * 
         * // add NoC circuitry - NoC and translators
         * NocInterconnect.addNoc(design, "designs/noc.xml");
         * 
         * // cluster design into SCCs NocClustering.clusterDesign(design);
         * 
         ...
         * 
         * // write out XML design XmlDesign.writeXMLDesign(design,
         * "designs/out.xml");
         * 
         * // write out verilog design VerilogOut.writeVerilogDesign(design);
         */

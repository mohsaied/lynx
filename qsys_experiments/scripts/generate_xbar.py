...
module "+project_name+" ();\n\n\
    ...
    for i in range(num_master):
        print >>top_file, "\twire qsys_slave_"+str(i)+"_done_done;"
        print >>top_file, "\twire qsys_slave_"+str(i)+"_readdatavalid_readdatavalid;\n"
...
def generate_xbar(num_master,width,num_pipeline,multiclock):

    project_name = 'x'+str(num_master)+'_w'+str(width)+'_p'+str(num_pipeline)+"_c"+str(multiclock);
    ...
    if os.path.exists('../experiments/'+project_name+'/simulation/mentor/reports/qsys_trace.txt'):
        ...
        if multiclock == 0:
            shutil.copy("../xbar_origs/x"+str(num_master)+".qsys", project_path+"/"+project_name+".qsys")
        else:
            shutil.copy("../xbar_origs/x"+str(num_master)+"_clk.qsys", project_path+"/"+project_name+".qsys")
            
        shutil.copy("../xbar_origs/qsys_master_hw.tcl",project_path)
        shutil.copy("../xbar_origs/qsys_slave_hw.tcl",project_path)
